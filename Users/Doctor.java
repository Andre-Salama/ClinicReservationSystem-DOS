...
//AOS: Amount of slots
    ...
    public static int Login(ArrayList<Doctor> AllDoctors, String email, String password) {
    ...
    public static boolean isTaken(ArrayList<Doctor> AllDoctors, String email) {
        for (int x = 0; x < AllDoctors.size(); x++)
